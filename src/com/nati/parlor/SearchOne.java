...
public class SearchOne extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		et=(EditText)findViewById(R.id.searcOneEdit);
		final Button but=(Button)findViewById(R.id.startSearch1);
		...
		but.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
						...
						{		    	 
							first=temp;
							pd=ProgressDialog.show(SearchOne.this, "title", "Loading....");
	...
	class RequestThread extends Thread
	{
		...
		public void run() {
			...
			HttpGet getReq=new HttpGet("http://10.0.2.2:81/salon/show_list.php?first="+first);
	...
	Handler handler=new Handler()
	{
		...
		public void handleMessage(Message msg) {
			...
			if(msg.what==0)
			{
				AlertDialog.Builder alertbuild=new AlertDialog.Builder(SearchOne.this);
